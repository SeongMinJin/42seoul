...
/*   Updated: 2022/11/17 12:17:12 by seojin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string Animal::getIdea( int idx ) const { (void)idx; return "Animal has no brain..."; }
void Animal::setIdea( int idx, std::string idea ) { (void)idx; (void)idea; std::cout << "Animal has no brain..." << std::endl; }