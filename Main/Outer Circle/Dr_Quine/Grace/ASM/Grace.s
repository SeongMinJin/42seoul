...
section .data
	msg: db "extern _fopen", 10, "extern _fprintf", 10, "extern _fclose", 10, "; This program will print its own source when run.", 10, "%%macro _macro 0", 10, 9, "push rbp", 10, 9, "mov rdi, source", 10, 9, "mov rsi, arg", 10, 9, "call _fopen", 10, 9, "mov rbp, rax", 10, 9, "mov rdi, rax", 10, 9, "mov rsi, msg", 10, 9, "mov rdx, meta", 10, 9, "mov rcx, meta", 10, 9, "call _fprintf", 10, 9, "mov rdi, rbp", 10, 9, "call _fclose", 10, 9, "pop rbp", 10, "%%endmacro", 10, 10, "section .text", 10, 9, "global _main", 10, "_main:", 10, 9, "_macro", 10, 9, "ret", 10, 10, "section .data", 10, 9, "msg: db ", 34, 37, 115, 10, 9, "meta: db ", 39, 37, 115, 39, ", 0", 10, 9, "source: db ", 34, "Grace_kid.s", 34, ", 0", 10, 9, "arg: db ", 34, "w", 34, ", 0", 0
