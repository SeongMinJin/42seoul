...
/*   Updated: 2022/07/18 16:02:51 by seojin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		trash[4] = 'H';
		trash[5] = 0;
		ft_list_push_back(&ab, trash);
		printf("NULL TEST\n\n0 : %s\n\n", ab->data);
		printf("0 : TRASH\n\n");
		free(ab);
		ft_list_push_back(&ex00, trash);
		printf("\n0 : JEONGBLE 1 : IS 2 : TRASH\n\n");
		printf("0 : %s 1 : %s 2 : %s\n", ex00-> data, (ex00-> next)-> data, ((ex00-> next)-> next)-> data);

		printf("\n===============EX05===============\n\n");

		printf("NULL TEST\n\n");
		t_list	*ex05 = ft_list_push_strs(0, 0);
		printf("OK\n\n\n");
		...
		printf("NULL TEST\n\n");
		t_list	*ee = 0;
		printf("before :");ft_list_foreach(ee, &pt);
		printf("\n\n");
		ft_list_reverse(&ee);
		printf("after  :");ft_list_foreach(ee, &pt);
		printf("\n\n\n");
		...
		t_list *nwww = 0;
		printf("NULL TEST \n\nbefore : ");
		ft_list_foreach(nwww, &pt);
		printf("\n\nafter : ");
		ft_list_remove_if(&nwww, "JEONGBLE", &ft_strcmp, &free);
		ft_list_foreach(nwww, &pt);

		printf("\n\n\nbefore : ");
		ft_list_foreach(ex08, &pt);
		printf("\n\nafter : ");
		ft_list_remove_if(&ex08, "IS", &ft_strcmp, &free);
		ft_list_foreach(ex08, &pt);
		printf("\n\n===============EX13===============\n");
		...
		printf("NULL TEST\n\n");
		printf("before : ");ft_list_foreach(nwww, &pt);
		printf("\n\n");
		ft_list_merge(&nwww, mm);
		printf("after  : ");ft_list_foreach(nwww, &pt);
		printf("\n\n\n");
		printf("before : ");ft_list_foreach(ex08, &pt);
		printf("\n\n");
		ft_list_merge(&ex08, mm);
		printf("after  : ");ft_list_foreach(ex08, &pt);
		printf("\n\n===============EX14===============\n\n");
		char **str4;
		...
		printf("NULL TEST\n\n");
		printf("before : \n\n");
		ft_sorted_list_insert(&nwww, s, &ft_strcmp);
		printf("after  : ");ft_list_foreach(nwww, &pt);

		printf("\n\n\nbefore : ");ft_list_foreach(ex14, &pt);
		...
		printf("NULL TEST\n\n");
		t_list *last = 0;
		printf("before      : ");ft_list_foreach(last, &pt);
		printf("\n\ninsert data : ");ft_list_foreach(ex14, &pt);
		ft_sorted_list_merge(&last, ex14, &ft_strcmp);
		printf("\n\n");
		printf("after       : ");ft_list_foreach(last, &pt);
		printf("\n\n\n");

		t_list	*ex17 = ft_list_push_strs(5, str5);
		printf("before      : ");ft_list_foreach(ex14, &pt);
		printf("\n\ninsert data : ");ft_list_foreach(ex17, &pt);
